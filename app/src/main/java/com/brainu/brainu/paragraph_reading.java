...
public class paragraph_reading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            word=new String[]{getResources().getString(R.string.paragraph_reading_5),getResources().getString(R.string.paragraph_reading_1),getResources().getString(R.string.paragraph_reading_2),getResources().getString(R.string.paragraph_reading_3),getResources().getString(R.string.paragraph_reading_4),getResources().getString(R.string.paragraph_reading_0)};
        }
